<template>
    <div>
        <div class="overflow-hidden bg-black pt-[82px] sm:-mx-[250px] sm:rounded-b-[50%] lg:-mx-[150px] lg:pt-[106px]">
            ...
            <div class="container relative bg-[url(/assets/images/world-map.png)] bg-cover">
                <div class="flex flex-col items-center gap-7 lg:flex-row">
                    <div
                        class="flex-1 pb-14 pt-14 text-white ltr:text-center rtl:text-center lg:max-w-[558px] lg:pb-52 ltr:lg:text-left rtl:lg:text-right xl:pt-36"
                    >
                        <h2 class="text-3xl font-extrabold sm:text-5xl lg:text-[70px] lg:leading-[89px]">
                            We take <span class="text-secondary">care</span> of your
                            <span
                                class="relative text-primary after:absolute after:inset-x-0 after:bottom-0 after:h-1 after:w-full after:bg-gradient-to-r after:from-primary/10 after:via-primary after:to-primary/10"
                                >business.</span
                            >
                        </h2>
                        <p class="mt-7 text-lg font-semibold">We believe that the power of marketing & SEO performance helps businesses to grow.</p>
                        <button type="button" class="btn mx-auto mt-10 block bg-white py-[18px] px-8 rtl:ml-auto lg:mx-0">Read More</button>
                    </div>
                    <div class="mb-10 w-full max-w-[500px] flex-none lg:mb-0" data-aos="fade-left" data-aos-duration="1000">
                        <img src="/assets/images/marketing/marketing-banner.png" class="rtl:rotate-y-180 xl:ml-[100px]" alt="" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <section class="bg-gradient-to-b from-white/[55%] to-transparent py-12 dark:from-white/5 md:py-20">
            <div class="container">
                ...
                <div
                    class="mt-24 grid grid-cols-1 gap-7 space-y-10 text-black ltr:text-right rtl:text-left sm:grid-cols-2 sm:space-y-0 lg:grid-cols-3"
                    data-aos="fade-up"
                ...
                >
                    ...
                    >
                        ...
                        <h3 class="mt-[86px] text-[22px] font-extrabold dark:text-white dark:group-hover:text-black">SEO Optimization</h3>
                    ...
                    >
                        ...
                        <h3 class="mt-[86px] text-[22px] font-extrabold dark:text-white dark:group-hover:text-black">Growth rating</h3>
                        <p class="text=lg mt-4 font-semibold text-gray dark:group-hover:text-black">
                            Our one of most valuable service is this, growth your business through digital marketing & advertising. Move forward your business
                            with growth rating.
                        </p>
                        <NuxtLink
                            to="/services-detail"
                    ...
                    >
                        ...
                        <h3 class="mt-[86px] text-[22px] font-extrabold dark:text-white dark:group-hover:text-black">Content Marketing</h3>
                        <p class="text=lg mt-4 font-semibold text-gray dark:group-hover:text-black">
                            You want to create content that helps them make better decisions and that establishes your business as THE authority in the process.
                            Do it right & get your result.
                        </p>
                        <NuxtLink
                            to="/services-detail"
                            class="mt-6 flex h-11 w-11 items-center justify-center rounded-full bg-[#F3F4F6] transition group-hover:bg-black group-hover:text-white ltr:float-right rtl:float-left dark:bg-gray-dark"
        ...
        <section class="bg-[url(/assets/images/marketing/business-owner.jpg)] bg-cover bg-center bg-no-repeat py-14 lg:py-[100px]">
            <div class="container relative">
                <div class="heading text-center">
                    <h6 class="!text-secondary">Who we are</h6>
                    <h4 class="!text-white">Our commitments to <span class="text-primary">business</span> owner</h4>
                </div>

                <div class="mx-auto grid max-w-[250px] gap-[30px] ltr:text-right rtl:text-left sm:max-w-none sm:grid-cols-2 lg:grid-cols-4">
                    <div
                        class="group flex cursor-pointer items-center gap-4 rounded-3xl bg-gray-dark py-10 px-6 transition duration-500 hover:bg-secondary"
                        data-aos="fade-up"
                        data-aos-duration="1000"
                    >
                        <div class="flex-1">
                            <count-up
                                class="pb-2.5 text-4xl font-black leading-none transition group-hover:text-black"
                                :startVal="0"
                                :end-val="10"
                                :duration="10"
                                :options="{ suffix: '+' }"
                            ></count-up>
                            <span class="font-semibold text-white transition group-hover:text-black">Year in Business</span>
                        </div>
                        <div class="shrink-0 text-[#47BDFF] group-hover:text-black">
                            <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_132_8975)">
                                    <path
                                        opacity="0.3"
                    ...
                    >
                        <div class="flex-1">
                            <count-up
                                ...
                                :options="{ suffix: '%' }"
                            ></count-up>
                            <span class="font-bold text-white transition group-hover:text-black">Team Members</span>
                        </div>
                        <div class="shrink-0 text-[#47BDFF] group-hover:text-black">
                            <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_132_8984)">
                                    <path
                                        opacity="0.3"
                    ...
                    >
                        <div class="flex-1">
                            <count-up
                                ...
                                :options="{ suffix: '+' }"
                            ></count-up>
                            <span class="font-bold text-white transition group-hover:text-black">Happy Clients</span>
                        </div>
                        <div class="shrink-0 text-[#47BDFF] group-hover:text-black">
                            <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_132_8993)">
                                    <path
                                        opacity="0.3"
                    ...
                    >
                        <div class="flex-1">
                            <count-up
                                ...
                                :options="{ suffix: '+' }"
                            ></count-up>
                            <span class="font-bold text-white transition group-hover:text-black">Project Done</span>
                        </div>
                        <div class="shrink-0 text-[#47BDFF] group-hover:text-black">
                            <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_132_9002)">
                                    <path
            ...
            <div class="container">
                <div class="flex flex-col items-center gap-[30px] lg:flex-row">
                    <div class="w-full max-w-[484px]">
                        <img src="/assets/images/marketing/work-img.png" class="rtl:rotate-y-180" alt="" />
                    </div>
                    <div>
                        ...
                        <div class="mt-12 grid grid-cols-3 space-y-7 text-center">
                            <div class="col-span-3 flex">
                                <div>
                                    ...
                                    <p class="mt-1 text-2xl font-bold">Project Idea</p>
                                </div>
                            </div>
                            <div class="col-span-3">
                                <h2 class="text-[70px] font-black leading-[57px] text-primary">2</h2>
                                <p class="mt-1 text-2xl font-bold">Marketing Plan</p>
                            </div>
                            <div class="col-span-3 flex justify-end">
                                <div class="relative">
                                    ...
                                    <p class="mt-1 text-2xl font-bold">Growth & Scale</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="bg-gradient-to-t from-transparent to-white/[55%] pt-10 dark:bg-gradient-to-b dark:from-white/5 dark:to-transparent lg:py-20">
            <div class="container">
                <div class="flex flex-col items-center gap-12 lg:flex-row lg:gap-28">
                    <div class="order-2 lg:order-1">
                        ...
                        <button type="button" class="btn mt-10 bg-secondary py-5 px-[50px] text-white hover:bg-primary">Know more</button>
                    </div>
        ...
        <section class="bg-gradient-to-b from-transparent to-white/[55%] py-10 dark:bg-gradient-to-t dark:from-white/5 dark:to-transparent lg:py-20">
            <div class="container">
                <div class="heading text-center">
                    <h6 class="!text-secondary">Our core value</h6>
                    <h4>The core values behind our work</h4>
                </div>
                <div class="grid grid-cols-1 justify-between gap-7 ltr:text-right rtl:text-left md:grid-cols-2" data-aos="fade-up" data-aos-duration="1000">
                    <div
                    ...
                    >
                        <div class="flex-1">
                            <h3 class="text-2xl font-extrabold text-primary">Execution</h3>
                    ...
                    >
                        <div class="flex-1">
                            <h3 class="text-2xl font-extrabold text-secondary">Accountability</h3>
                            <p class="mt-4 text-lg font-semibold">
                    ...
                    >
                        <div class="flex-1">
                            <h3 class="text-2xl font-extrabold text-secondary">Growth</h3>
                            <p class="mt-4 text-lg font-semibold">
                    ...
                    >
                        <div class="flex-1">
                            <h3 class="text-2xl font-extrabold text-primary">Team Work</h3>
                            <p class="mt-4 text-lg font-semibold">
                                Marketing can be defined as all the different activities that are involved in making products available to satisfy the needs of
                                the customers.
                            </p>
                        </div>
                        <div class="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-[rgba(71,189,255,0.06)] text-[#47BDFF]">
        ...
        <section class="overflow-hidden py-12 lg:py-24">
            ...
            <div class="container relative px-16">
                ...
                <swiper
                    ...
                    :key="store.direction === 'rtl' ? 'true' : 'false'"
                >
                    <swiper-slide class="relative text-center">
                        <span class="absolute inset-x-0 -top-5">
                            <img src="/assets/images/marketing/team-shadow.svg" class="mx-auto" alt="" />
                        </span>
                    ...
                    <swiper-slide class="relative text-center">
                        <span class="absolute inset-x-0 -top-5">
                            <img src="/assets/images/marketing/team-shadow1.svg" class="mx-auto" alt="" />
                        </span>
                        <div class="mx-auto w-48 rounded-full">
        ...
        <section class="bg-gradient-to-t from-transparent to-white/[55%] py-12 dark:bg-gradient-to-b dark:from-white/5 dark:to-transparent lg:py-24">
            <div class="container">
                ...
                <div
                    class="mt-14 grid grid-cols-1 justify-between gap-10 sm:grid-cols-2 md:mt-20 lg:grid-cols-3 lg:gap-7"
                    data-aos="fade-up"
                    data-aos-duration="1000"
                >
                    <div
                    ...
                    >
                        ...
                        <h5 class="font-blod mt-4 text-center text-sm text-black group-hover:text-white">Billed every month</h5>
                    </div>
                    <div
                    ...
                    >
                        ...
                        <div class="absolute top-0 group-hover:text-black ltr:right-0 rtl:left-0 dark:group-hover:text-white">
                ...
                <div class="relative z-10 lg:flex">
                    <div class="heading text-center lg:mb-0 lg:w-1/3 ltr:lg:pr-10 ltr:lg:text-left rtl:lg:pl-10 rtl:lg:text-right">
                        ...
                        <div class="block dark:hidden">
                            <svg class="mx-auto" width="328" height="328" viewBox="0 0 328 328" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
