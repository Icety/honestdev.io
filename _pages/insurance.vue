<template>
    <div>
                ...
                <div class="flex flex-col gap-7 lg:flex-row">
                    ...
                    <div class="flex flex-1 flex-col justify-between text-center ltr:md:text-left rtl:md:text-right">
                        <div>
                            ...
                            <p class="lg:text-lg">
                                From lost luggage to unexpected medical expenses, we’re there to help when things don’t go to plan. With basic cover from only
                                $2.84 a day 1, Real Travel Insurance can give you affordable peace of mind when you’re travelling.
                            </p>
                        </div>
                        ...
                        <div class="mt-4 grid gap-4 rounded-[10px] bg-white p-5 dark:bg-gray-dark sm:grid-cols-3 ltr:lg:-ml-60 rtl:lg:-mr-60 xl:gap-[72px]">
                            <div class="flex items-center gap-4">
                                <div
                                    class="grid h-14 w-14 flex-none place-content-center rounded-[150px] rounded-br-[20px] bg-primary text-white lg:h-20 lg:w-20"
                                >
                ...
                <div class="flex flex-col items-center gap-8 text-center ltr:md:text-left rtl:md:text-right lg:flex-row">
                    <div class="w-full max-w-[500px] flex-none space-y-8" data-aos="fade-right" data-aos-duration="1000">
                        ...
                        <div class="space-y-5">
                            ...
                            <p class="text-lg">
                                We always try our clients to give the best support. a reader will be distracted by the readable content of a creative page It is
                                a long established
                            </p>
                        </div>
        ...
        <section class="py-[60px] px-5 dark:bg-gray-dark">
            <Testimonial class="mx-auto max-w-[1440px] rounded-[32px] py-14 dark:bg-black md:py-20" :feedbacks="feedbacks" type="modern-saas"></Testimonial>
        </section>
            ...
            <div class="container">
                <div class="flex flex-col items-center justify-center lg:flex-row lg:justify-between">
                    ...
                    <div class="mb-8 flex items-center justify-end gap-4 lg:mb-0">
                        <NuxtLink
                            to="/blog"
                            class="text-sm font-extrabold text-white transition hover:text-secondary dark:text-white dark:hover:text-secondary"
                        >
                            View All
                        </NuxtLink>
                        <button
                        ...
                        <div class="rounded-3xl bg-gray-dark dark:bg-black">
                            ...
                            <div class="p-5 text-sm font-bold">
                                ...
                                <div class="mt-6 flex items-center justify-between text-secondary">
                                    ...
                                    <NuxtLink to="blog-details" class="text-primary transition hover:text-secondary">
