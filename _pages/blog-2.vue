                ...
                <div class="relative">
                    <div class="text-center lg:max-w-[754px] ltr:lg:text-left rtl:lg:text-right">
                        ...
                        <p class="mt-7 text-base font-semibold xl:text-lg">
                            lorem ipsum is a placeholder text to demonstrate the visual form of a typeface without relying on very meaningful content like this
                            one for example.
                        </p>
                            ...
                            <div class="flex rounded-[10px]">
                                <div>
                                    ...
                                    <NuxtLink
                                        ...
                                        >16 Unheard Ways To Achieve Greater Walker</NuxtLink
                                    >
                                ...
                                <div class="group flex gap-[14px]">
                                    ...
                                    <div class="flex-1">
                                        <NuxtLink
                                            ...
                                            >5 Easy Ways You Can Turn Future Into Success</NuxtLink
                                        >
                            ...
                            <div class="flex gap-3">
                                ...
                                <div>
                                    <NuxtLink
                                        ...
                                        >Your Light Is About To Stop Being Relevant</NuxtLink
                                    >
                                    <div class="mt-2.5 flex items-center gap-2">
                                        <span>
                                            <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="flex gap-3">
                                ...
                                <div>
                                    <NuxtLink
                                        to="javascript:"
                                        class="text-[15px] font-bold leading-5 text-black duration-200 hover:text-secondary dark:text-white dark:hover:text-secondary"
                                        >3 Easy Ways To Make Your iPhone Faster</NuxtLink
                                    >
                                    <div class="mt-2.5 flex items-center gap-2">
                                        <span>
                                            <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="flex gap-3">
                                ...
                                <div>
                                    <NuxtLink
                                        to="javascript:"
                                        class="text-[15px] font-bold leading-5 text-black duration-200 hover:text-secondary dark:text-white dark:hover:text-secondary"
                                        >Secrets Your Parents Never Told You About Bulb</NuxtLink
                                    >
                                    <div class="mt-2.5 flex items-center gap-2">
                                        <span>
                                            <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="mt-5 grid grid-cols-1 gap-5 lg:grid-cols-2" data-aos="flip-left" data-aos-duration="1000">
                    ...
                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                        <div class="group relative h-[263px] w-full overflow-hidden rounded-[10px] lg:max-w-[263px]">
                            ...
                            <div class="absolute bottom-4 left-5 right-5 z-[1] text-white">
                                <NuxtLink to="javascript:" class="text-[19px] font-bold duration-200 hover:text-secondary dark:hover:text-secondary"
                                    >The Top Trends For Summer Wedding Dressing</NuxtLink
                                >
                        ...
                        <div class="group relative h-[263px] w-full overflow-hidden rounded-[10px] lg:max-w-[263px]">
                            ...
                            <div class="absolute bottom-4 left-5 right-5 z-[1] text-white">
                                <NuxtLink to="javascript:" class="text-[19px] font-bold duration-200 hover:text-secondary dark:hover:text-secondary"
                                    >UBC researchers use drones to track jellyfish blooms</NuxtLink
                                >
                                <div class="mt-[14px] flex items-center gap-2">
                                    <span>
                                        <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="group relative h-[263px] w-full overflow-hidden rounded-[10px] lg:max-w-[263px]">
                            ...
                            <div class="absolute bottom-4 left-5 right-5 z-[1] text-white">
                                <NuxtLink to="javascript:" class="text-[19px] font-bold duration-200 hover:text-secondary dark:hover:text-secondary"
                                    >Guide to Throwing the Perfect Summer Pool Party</NuxtLink
                                >
                                <div class="mt-[14px] flex items-center gap-2">
                                    <span>
                                        <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="group relative h-[263px] w-full overflow-hidden rounded-[10px] lg:max-w-[263px]">
                            ...
                            <div class="absolute bottom-4 left-5 right-5 z-[1] text-white">
                                <NuxtLink to="javascript:" class="text-[19px] font-bold duration-200 hover:text-secondary dark:hover:text-secondary"
                                    >Park’s Shinoda says ‘no way’ to a hologram Chester Bennington</NuxtLink
                                >
                                <div class="mt-[14px] flex items-center gap-2">
                                    <span>
                                        <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <swiper-slide>
                        ...
                        <div>
                            ...
                            <NuxtLink
                                to="javascript:"
                                class="text-lg font-extrabold text-black duration-200 hover:text-secondary dark:text-white dark:hover:text-secondary"
                                >SuperShe Island: Women-only luxury retreat opening in Finland</NuxtLink
                            >
                        </div>
                    </swiper-slide>
                    ...
                    <swiper-slide>
                        ...
                        <div>
                            ...
                            <NuxtLink
                                to="javascript:"
                                class="text-lg font-extrabold text-black duration-200 hover:text-secondary dark:text-white dark:hover:text-secondary"
                                >Overtourism and the big chill: travel trends in 2018</NuxtLink
                            >
                        </div>
                    </swiper-slide>
                </swiper>
                                ...
                                <div class="relative overflow-hidden rounded-[10px]">
                                    ...
                                    <div class="bg-white p-3">
                                        <NuxtLink
                                            to="javascript:"
                                            class="text-xl font-bold text-black duration-200 line-clamp-2 hover:text-secondary dark:hover:text-secondary"
                                            >Through the Mist</NuxtLink
                                        >
                                        <p class="mt-2 mb-3 text-sm font-medium line-clamp-2">
                            ...
                            <div class="space-y-6">
                                <div class="relative h-[306px] w-full overflow-hidden rounded-[10px]">
                                    ...
                                    <div class="absolute bottom-5 left-5 right-5">
                                        <NuxtLink to="javascript:" class="text-xl font-bold text-white hover:text-secondary dark:hover:text-secondary"
                                            >The Road Ahead</NuxtLink
                                        >
                                ...
                                <div class="relative h-[306px] overflow-hidden rounded-[10px]">
                                    ...
                                    <p
                                        class="absolute top-5 rounded bg-primary py-1 px-2.5 text-[12px] font-extrabold leading-4 text-white ltr:left-5 rtl:right-5"
                                    >
                                        ADVENTURE
                                    </p>
                                </div>
                        ...
                        <div class="mt-5 flex flex-col gap-6 sm:flex-row">
                            ...
                            <div>
                                ...
                                <NuxtLink
                                    ...
                                    >How 7 things will change the way you approach photographs</NuxtLink
                                >
                        ...
                        <div class="flex flex-col gap-6 sm:flex-row">
                            ...
                            <div>
                                ...
                                <NuxtLink
                                    to="javascript:"
                                    class="mt-3 text-xl font-bold text-black duration-200 hover:text-secondary dark:text-white dark:hover:text-secondary"
                                    >Online professional animation courses for beginners</NuxtLink
                                >
                                <div class="mt-3 flex items-center gap-2.5">
                                    <span>
                                        <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="mt-5 mb-5 flex gap-3">
                            ...
                            <div>
                                ...
                                <NuxtLink
                                    ...
                                    >Julie Chair A Modern Durable Plastic ALMA Design Chair</NuxtLink
                                >
                            </div>
                        </div>
                        ...
                        <div class="mt-5 mb-5 flex gap-3">
                            ...
                            <div>
                                ...
                                <NuxtLink
                                    ...
                                    >An Exciting Car Representing Aston Martin's Future</NuxtLink
                                >
                            </div>
                        </div>
                        <div class="border-b border-dashed border-gray/50"></div>
                        <div class="mt-5 flex gap-3">
                            ...
                            <div>
                                ...
                                <NuxtLink
                                    to="javascript:"
                                    class="text-base font-bold text-black duration-200 hover:text-secondary dark:text-white dark:hover:text-secondary"
                                    >Ultra by Ultra Is A Ultimate Minimalist Wallet Solution.</NuxtLink
                                >
                            </div>
                        </div>
                    </div>
