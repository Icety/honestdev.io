        ...
        <div class="container">
          <div class="items-center py-10 md:flex md:h-[400px] md:py-0">
            <div class="heading relative mb-0 md:w-[725px]">
              <h4 class="!text-white">Hariharalaya App</h4>
              <p
              ...
              >
                The unofficial Hariharalaya app that you can use to keep doing your morning practice after having visited the Hariharalaya retreat.
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div>
          ...
          <div class="overflow-x-auto overflow-y-hidden">
            <ul class="flex w-[520px] justify-between gap-4 md:w-auto md:justify-start md:gap-7" data-aos="fade-up" data-aos-duration="1000">
              <li
              ...
              >
                <div>
                  <svg width="21" height="30" viewBox="0 0 21 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M5 30C7.75999 30 9.99999 27.76 9.99999 25V20H5C2.24 20 0 22.24 0 25C0 27.76 2.24 30 5 30Z" fill="#0ACF83" />
        ...
        <div class="py-14 md:py-20">
          ...
          <ul class="list-disc space-y-4 font-semibold leading-6 ltr:ml-[18px] rtl:mr-[18px] md:text-lg ltr:md:pl-4 rtl:md:pr-4">
            <li>Setting alarms that will ring the gong sound heard at the retreat.</li>
            <li>Configuring lengths of the different breath exercises and meditation.</li>
            <li>Configuring the voice that guides you through the exercises.</li>
          </ul>
        </div>
        <div class="pb-14 md:pb-20">
          ...
          >
            During my time at the Hariharalaya retreat in April 2024 I learned a lot. One of the things I took with me was a new morning practice.
            This however required setting timers, closing them, being annoyed by their sound, so I decided to built this app.
          </p>
          <p
          ...
          >
            The Hariharalaya app makes it easy to wake up by the soothing sound of a gong followed by tools to do your morning practice listening to the
            guidance of your favorite Hariharalaya trainer.
          </p>
        </div>
        <div class="grid gap-[30px] sm:grid-cols-2">
          <img src="/assets/images/projects/hariharalaya/screenshot1.jpeg" alt="portfolio" class="rounded-[32px]" data-aos="fade-up" data-aos-duration="1000" />
          <img src="/assets/images/projects/hariharalaya/screenshot2.jpeg" alt="portfolio" class="rounded-[32px]" data-aos="fade-up" data-aos-duration="1000" />
        </div>
      </div>
    </section>
