            ...
            <div class="relative" :data-aos="store.direction === 'rtl' ? 'fade-right' : 'fade-left'" data-aos-duration="1000">
              ...
              >
                ...
                <path
                    ...
                    fill="#47BDFF"
                />
                <path d="M133.183 167.719L136.341 176.773C136.461 173.254 136.581 169.794 136.643 166.395L133.183 167.719Z" fill="#47BDFF" />
                <path
                ...
                <path
                    ...
                    stroke-linejoin="round"
                />
                <path d="M23.8353 222.761L19.1901 228.787" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                <path
                ...
                <path
                    ...
                    stroke-linejoin="round"
                />
                <path d="M142.444 1V6.02486" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M132.672 10.7759H137.694" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M142.444 20.5542V15.5293" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M152.216 10.7759H147.192" stroke="white" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                <path
      ...
      <div class="container">
        <div class="overflow-x-auto">
          <ul class="filters portfolio-filter mx-auto flex w-max gap-7 whitespace-nowrap pb-2.5 font-bold dark:text-white">
            ...
            <li class="filter" :class="{ active: activeTab === 'application' }">
              <button
                  type="button"
                  class="rounded-[10px] bg-gray/5 py-4 px-5 leading-5 transition hover:bg-secondary hover:text-white"
            ...
            <li class="filter" :class="{ active: activeTab === 'other' }">
              <button
                  type="button"
                  class="rounded-[10px] bg-gray/5 py-4 px-5 leading-5 transition hover:bg-secondary hover:text-white"
        ...
        <div class="projects mt-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <div class="project" :class="project.categories.indexOf(activeTab) !== -1 ? 'block' : 'hidden'" v-for="project in projects" :key="project.id">
            <div
            ...
            >
              <NuxtLink :to="project.url" class="absolute top-0 h-full w-full ltr:left-0 rtl:right-0"></NuxtLink>
              <img :src="project.image" alt="project-1" class="h-52 w-full rounded-t-3xl object-cover" />
...
const projects = [
  {
    id: 1,
    url: '/projects/hariharalaya',
    image: '/assets/images/projects/hariharalaya/preview.jpeg',
    title: 'Hariharalaya',
