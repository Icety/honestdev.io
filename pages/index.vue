...
<template>
  <div>
    <div class="relative overflow-hidden bg-black pt-[82px] sm:-mx-[250px] sm:rounded-b-[50%] lg:-mx-[150px] lg:pt-[106px]">
      <div class="relative">
        ...
        <div class="container">
          <div class="relative bg-[url('/assets/images/world-map.png')] bg-cover bg-top bg-no-repeat pt-14 pb-0 lg:pt-20 lg:pb-60 xl:pt-36">
            <div class="relative z-[1] text-center text-white lg:w-3/5 ltr:lg:text-left rtl:lg:text-right xl:w-1/2">
              ...
              <NuxtLink to="/about-us" class="btn mx-auto mt-2 block w-fit bg-white lg:mx-0 lg:rtl:ml-auto">read more</NuxtLink>
            </div>
            <div
      ...
      <div class="container">
        ...
        <div class="projects grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <div class="project" :class="activeTab === 'all' || activeTab === 'web' ? 'block' : 'hidden'">
            ...
            >
              <NuxtLink to="/portfolio-detail" class="absolute top-0 left-0 h-full w-full"></NuxtLink>
          ...
          >
            ...
            <div class="mt-auto border-t-2 border-[#BBC0D0]/50 pt-7">
              <div class="mb-3 flex flex-col items-center justify-center sm:flex-row sm:justify-between">
                ...
                <NuxtLink to="javascript:" class="btn bg-black text-xl text-white group-hover:bg-white group-hover:text-black xl:w-44"
                >$499</NuxtLink
                >
              </div>
              <span
