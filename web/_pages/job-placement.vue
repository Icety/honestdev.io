            ...
            <div class="container">
                <div class="flex flex-col gap-8 lg:flex-row lg:gap-0">
                    <div class="text-center text-white lg:mt-40 ltr:lg:text-left rtl:lg:text-right">
                        <h2 class="text-4xl font-black sm:text-6xl sm:leading-[75px]">
                            Get Your <span class="text-secondary">Developers</span> Job With Plurk.
                        </h2>
            ...
            <div class="container">
                ...
                <div class="grid grid-cols-2 gap-3 sm:gap-5 md:grid-cols-4" data-aos="fade-up" data-aos-duration="1000">
                    <div class="rounded-xl border-[1px] border-dashed border-gray/40 py-7 text-center dark:bg-black">
                        ...
                        <count-up class="mt-5 text-4xl font-bold text-secondary" startVal="0" :end-val="675" :duration="10" :options="{ suffix: 'k+' }">
                        </count-up>
                    ...
                    <div class="rounded-xl border-[1px] border-dashed border-gray/40 py-7 text-center dark:bg-black">
                        ...
                        <count-up class="mt-5 text-4xl font-bold text-secondary" startVal="0" :end-val="145" :duration="10" :options="{ suffix: '+' }">
                        </count-up>
                    ...
                    <div class="rounded-xl border-[1px] border-dashed border-gray/40 py-7 text-center dark:bg-black">
                        ...
                        <count-up class="mt-5 text-4xl font-bold text-secondary" startVal="0" :end-val="245" :duration="10" :options="{ suffix: '+' }">
                        </count-up>
                    ...
                    <div class="rounded-xl border-[1px] border-dashed border-gray/40 py-7 text-center dark:bg-black">
                        ...
                        <count-up class="mt-5 text-4xl font-bold text-secondary" startVal="0" :end-val="35" :duration="10" :options="{ suffix: '+' }">
                        </count-up>
        ...
        <section class="py-14 lg:py-24">
            <div class="container">
                ...
                <ul class="filters portfolio-filter mb-14 flex flex-row gap-6 overflow-auto whitespace-nowrap pb-2.5 font-bold md:justify-center">
                    ...
                    <li class="filter" :class="{ active: activeTab === 'transportation' }">
                        <button
                            type="button"
                ...
                <div class="projects mt-12 grid grid-cols-1 gap-[15px] sm:grid-cols-2 lg:grid-cols-3" data-aos="flip-left" data-aos-duration="1000">
                    <div class="project relative rounded-xl bg-white py-9 text-center dark:bg-white/10" :class="activeTab === 'all-jobs' ? 'block' : 'hidden'">
                    ...
                    <div
                        ...
                        :class="activeTab === 'technology' ? 'block' : 'hidden'"
                    >
                        <img src="/assets/images/job/dribbble.svg" class="mx-auto" alt="" />
                        <h5 class="mt-[14px] text-base font-medium text-black dark:text-white">Dribbble</h5>
                        <h3 class="mt-5 text-xl font-bold text-secondary">Customer Support Agent</h3>
                    ...
                    <div
                        class="project relative rounded-xl bg-white py-9 text-center dark:bg-white/10"
                        :class="activeTab === 'transportation' ? 'block' : 'hidden'"
                    >
                        <img src="/assets/images/job/apple.svg" class="mx-auto" alt="" />
                        <h5 class="mt-[14px] text-base font-medium text-black dark:text-white">Apple</h5>
                        <h3 class="mt-5 text-xl font-bold text-secondary">Senior Product Designer</h3>
                    ...
                    <div class="project relative rounded-xl bg-white py-9 text-center dark:bg-white/10" :class="activeTab === 'marketing' ? 'block' : 'hidden'">
                        <img src="/assets/images/job/apple.svg" class="mx-auto" alt="" />
                        <h5 class="mt-[14px] text-base font-medium text-black dark:text-white">Apple</h5>
                        <h3 class="mt-5 text-xl font-bold text-secondary">Senior Product Designer</h3>
                        <p class="mt-[14px] text-base font-semibold">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit amet.</p>
                    ...
                    <div class="project relative rounded-xl bg-white py-9 text-center dark:bg-white/10" :class="activeTab === 'sales' ? 'block' : 'hidden'">
                        <img src="/assets/images/job/dribbble.svg" class="mx-auto" alt="" />
                        <h5 class="mt-[14px] text-base font-medium text-black dark:text-white">Dribbble</h5>
                        <h3 class="mt-5 text-xl font-bold text-secondary">Customer Support Agent</h3>
                        <p class="mt-[14px] text-base font-semibold">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit amet.</p>
...
<script setup lang="ts">
    ...
    useHead({ title: 'Job Placement' });
    const store = useAppStore();
    const activeTab = ref('all-jobs');
</script>
