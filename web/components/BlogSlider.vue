<template>
    <section class="py-14 lg:py-[100px]">
        <div class="container">
            <div class="flex flex-col items-center justify-center lg:flex-row lg:justify-between" :class="{ 'mb-10': !title }">
                <div class="heading text-center ltr:lg:text-left rtl:lg:text-right" :class="{ 'mb-0': !title }">
                    <h6 v-if="title" :class="{ '!text-secondary': type.toLowerCase() === 'modern-saas' }">{{ title }}</h6>
            ...
            >
                <template v-if="type.toLowerCase() === 'service'">
                    <swiper-slide v-for="blog in blogs" :key="blog.id">
                        ...
                        >
                            <NuxtLink to="/blog-details" class="absolute top-0 h-full w-full ltr:left-0 rtl:right-0"></NuxtLink>
                            <img :src="blog.thumbnail" alt="blog" class="h-52 w-full rounded-t-3xl object-cover" />
                        ...
                        <div class="rounded-3xl bg-white dark:bg-gray-dark">
                            ...
                            <div class="p-5 text-sm font-bold">
                                ...
                                <div class="mt-6 flex items-center justify-between text-secondary">
                                    <span>{{ blog.date }}</span>
                                    <NuxtLink to="/blog-details" class="transition hover:text-primary">
