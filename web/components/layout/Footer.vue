            ...
            <div class="grid gap-y-10 gap-x-4 py-14 sm:grid-cols-3 lg:grid-cols-5 lg:py-[100px]">
                ...
                <div>
                    <ul class="flex flex-col gap-3 font-bold">
                        ...
                        <li>
                            <NuxtLink to="/" class="inline-block transition hover:scale-110 hover:text-secondary">Home</NuxtLink>
                        </li>
                        <li>
...
<!--                        </li>-->
                ...
                <div class="invisible">
                    <ul class="flex flex-col gap-3 font-bold">
                        ...
                        <li>
                            <NuxtLink to="/services-detail" class="inline-block transition hover:scale-110 hover:text-secondary">UI/UX Design</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/services-detail" class="inline-block transition hover:scale-110 hover:text-secondary">Web Development</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/services-detail" class="inline-block transition hover:scale-110 hover:text-secondary">Digital Marketing</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/services-detail" class="inline-block transition hover:scale-110 hover:text-secondary">App Development</NuxtLink>
                        </li>
                    </ul>
                </div>
                <div class="invisible">
                    <ul class="flex flex-col gap-3 font-bold">
                        ...
                        <li>
                            <NuxtLink to="/terms-conditions" class="inline-block transition hover:scale-110 hover:text-secondary">Terms & Conditions</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/privacy-policy" class="inline-block transition hover:scale-110 hover:text-secondary">Privacy Policy</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/faq" class="inline-block transition hover:scale-110 hover:text-secondary">FAQs</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/blog" class="inline-block transition hover:scale-110 hover:text-secondary">Blog</NuxtLink>
                        </li>
                    </ul>
                </div>
                <div>
